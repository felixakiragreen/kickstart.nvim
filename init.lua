...
vim.keymap.set({ 'n', 'v' }, 'j', 'h', { noremap = true, desc = 'Move left' })
vim.keymap.set({ 'n', 'v' }, 'k', 'j', { noremap = true, desc = 'Move down' })
vim.keymap.set({ 'n', 'v' }, 'l', 'l', { noremap = true, desc = 'Move right' })
vim.keymap.set({ 'n', 'v' }, 'h', 'i', { noremap = true, desc = 'Insert mode' })

vim.keymap.set({ 'n', 'v' }, 'I', 'K', { noremap = true, desc = 'Help' })
vim.keymap.set({ 'n', 'v' }, 'J', 'H', { noremap = true, desc = 'Screen top' })
vim.keymap.set({ 'n', 'v' }, 'K', 'J', { noremap = true, desc = 'Join lines' })
vim.keymap.set({ 'n', 'v' }, 'L', 'L', { noremap = true, desc = 'Screen bottom' })
vim.keymap.set({ 'n', 'v' }, 'H', 'I', { noremap = true, desc = 'Insert at beginning of line' })
